<?php
//####################################################################
class CreateQuoteForm extends View
{
	public $Registrar;
...
<div class="container" id="CreateNewQuote">
    ...
    <div class="content-text" style="width: 100%; min-height: 1px;">
        ...
        <b>Create a new quote</b><br />
        Fields marked with an asterisk are required<br /><br />

        <form method="post" action="' . $this->Registrar->Get('Config')->RootURL . '/financial_tools/accounting/quoting/create_quote/controller.php">
        ...
        * Total:<br />
        ...
        <input type="submit" name="CreateQuote" value="Save Quote" />' .
