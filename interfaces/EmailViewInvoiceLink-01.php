...
<html lang="en">
    ...
    <body>
        <img src="' . $inRegistrar->Get('Config')->RootURL . '/media/images/TOPSPEK_LOGO_012.png' /><br /><br />
        ...
        David Mortimer<br /><br />
        Chief Software Engineer<br />
        Topspek Software Systems<br />
        Website: ' . $inRegistrar->Get('Config')->RootURL . '<br />
