...
class Header extends View
{
    ...
    {
        //$this->html = '<div>UkGameCoder</div>';
        $this->html .= '<div><img src="' . $this->Registrar->Get('Config')->RootURL . '/media/images/UKAPPCODER_002.png"  style="/*width: 446px; height: 137px;*/ max-width: 446px; max-height: 137px;" alt="UKGC_LOGO" /></div>';
